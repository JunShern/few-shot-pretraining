...
# python finetune_with_dataset.py -d configs/dataset/QuestionAnswerStringsV2Criterion_1k.yaml -f configs/finetune/default.json -m gpt2-xl
...
# python finetune_with_dataset.py -d configs/dataset/QuestionAnswerStringsV2Criterion_100k.yaml -f configs/finetune/default.json -m gpt2-xl
...
# python finetune_with_dataset.py -d configs/dataset/ExamplesStringsCriterion_100k.yaml -f configs/finetune/default.json -m gpt2-xl
